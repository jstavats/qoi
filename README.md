...
The purpose of this repository is to test adding a greyscale pixel (1 byte per pixel) image support 
to the QOI file format.  QOI currently supports colour pixels (3 and 4 bytes per pixels) currently.
