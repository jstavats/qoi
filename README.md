...
The purpose of this repository is to test creating a greyscale pixel (1 byte per pixel) capable version of 
the QOI file format.  QOI currently supports colour pixels (3 and 4 bytes per pixels).
